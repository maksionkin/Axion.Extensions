...
/// <summary>
/// Provides extension methods for configuring branch and tag references on a <see cref="GitFileProviderOptions"/> instance.
/// </summary>
public static class GitSmartFileProviderOptionsExtensions
{
    extension(GitFileProviderOptions options)
    {
        /// <summary>
        ...
        /// <returns>The current <see cref="GitFileProviderOptions"/> instance with the branch reference set.</returns>
        public GitFileProviderOptions UseBranch(string branch)
        {
        ...
        /// <returns>The current <see cref="GitFileProviderOptions"/> instance with the reference set to the specified tag.</returns>
        public GitFileProviderOptions UseTag(string tag)
        {
            ArgumentNullException.ThrowIfNull(options);
