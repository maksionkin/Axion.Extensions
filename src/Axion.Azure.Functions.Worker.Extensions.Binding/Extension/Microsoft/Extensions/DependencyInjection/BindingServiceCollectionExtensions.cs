...
public static class BindingServiceCollectionExtensions
{
    ...
    extension(IServiceCollection services)
    {
        ...
        public IServiceCollection AddWorkerBinding()
        {
        ...
        /// <returns>The <see cref="IServiceCollection"/> with the output binding services added.</returns>
        public IServiceCollection AddConverter<TInput, TOutput>(Func<TInput, TOutput> convert) =>
        ...
        /// <param name="convert">The delegate used to perform the conversion.</param>
        /// <returns>The <see cref="IServiceCollection"/> with the output binding services added.</returns>
        public IServiceCollection AddAsyncConverter<TInput, TOutput>(Func<TInput, CancellationToken, ValueTask<TOutput>> convert) =>
